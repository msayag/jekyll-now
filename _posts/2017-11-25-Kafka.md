...
```
After adding the following to the [build.gradle](Specific/build.gradle) file, the class Item will be created every time the _build_ task is invoked.
```groovy
...
<section id="downloads" class="clearfix">
  <a href="https://github.com/msayag/howto-kafka/zipball/master" id="download-zip" class="button"><span>Download .zip</span></a>
  <a href="https://github.com/msayag/howto-kafka/tarball/master" id="download-tar-gz" class="button"><span>Download .tar.gz</span></a>
  <a href="https://github.com/msayag/howto-kafka" id="view-on-github" class="button"><span>View on GitHub</span></a>
</section>
